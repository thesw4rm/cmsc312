...
1. Loop until all user/printer processes/threads are created
    1. User
        a. Create forked process and random seed value
        b. Free unused variables
        c. Start user process
        d. Set pid in pid array for signal handler
    2. Printer
        a. Create printer thread
        b. Set pthread object in pthread array and number in `ptd_num`
